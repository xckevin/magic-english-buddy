...
| ID | 任务 | 优先级 | 工时 | 状态 | 完成日期 |
|----|------|--------|------|------|----------|
| P0-2-01 | 设计 Design Token (颜色/字体/间距) | P0 | 4h | ⚪ | |
| P0-2-02 | 实现 Button 组件 | P0 | 2h | ⚪ | |
| P0-2-03 | 实现 Modal 组件 | P0 | 3h | ⚪ | |
| P0-2-04 | 实现 Loading 组件 | P0 | 2h | ⚪ | |
| P0-2-05 | 实现 Toast 组件 | P1 | 3h | ⚪ | |
| P0-2-06 | 实现 Icon 图标系统 | P1 | 3h | ⚪ | |
| P0-2-07 | 编写 L1 故事数据 (10 个) | P0 | 8h | ⚪ | |
| P0-2-08 | 导入基础词典数据 (1000 词) | P0 | 4h | ⚪ | |
| P0-2-09 | 实现数据初始化服务 | P0 | 4h | ⚪ | |
| P0-2-10 | 创建首次启动检测逻辑 | P1 | 2h | ⚪ | |
...
| ID | 任务 | 优先级 | 工时 | 状态 | 完成日期 |
|----|------|--------|------|------|----------|
| P0-3-01 | 实现 TTS Service | P0 | 6h | ⚪ | |
| P0-3-02 | 实现 WordHighlight 组件 | P0 | 6h | ⚪ | |
| P0-3-03 | 实现 StoryContent 组件 | P0 | 4h | ⚪ | |
| P0-3-04 | 实现阅读器控制栏 | P0 | 4h | ⚪ | |
| P0-3-05 | 实现字典查询服务 | P0 | 4h | ⚪ | |
| P0-3-06 | 实现 DictionaryPopup 组件 | P0 | 4h | ⚪ | |
| P0-3-07 | 实现语速控制 (0.8x/1.0x/1.2x) | P1 | 2h | ⚪ | |
| P0-3-08 | 实现单词点击发音 | P1 | 2h | ⚪ | |
| P0-3-09 | 创建 ReaderPage 页面 | P0 | 4h | ⚪ | |
| P0-3-10 | 实现阅读进度保存 | P1 | 3h | ⚪ | |
...
| ID | 任务 | 优先级 | 工时 | 状态 | 完成日期 |
|----|------|--------|------|------|----------|
| P0-4-01 | 实现引导页背景动画 | P0 | 4h | ⚪ | |
| P0-4-02 | 实现蛋壳破碎动画 | P0 | 6h | ⚪ | |
| P0-4-03 | 实现麦克风长按交互 | P0 | 4h | ⚪ | |
| P0-4-04 | 实现 Buddy 起名流程 | P0 | 3h | ⚪ | |
| P0-4-05 | 创建 OnboardingPage | P0 | 4h | ⚪ | |
| P0-4-06 | 实现简易故事列表页 (临时) | P1 | 4h | ⚪ | |
| P0-4-07 | 端到端流程测试 | P0 | 4h | ⚪ | |
| P0-4-08 | 离线功能测试 | P0 | 3h | ⚪ | |
| P0-4-09 | 低端设备性能测试 | P1 | 3h | ⚪ | |
| P0-4-10 | Bug 修复与优化 | P0 | 8h | ⚪ | |
